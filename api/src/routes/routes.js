...
routes.put('/users/profile/edit', UserController.editProfile)
routes.put('/users/darkmode/toggle', UserController.toggleDarkMode)
routes.put('/users/locale/change', UserController.changeLocale)
